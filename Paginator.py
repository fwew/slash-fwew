...
https://github.com/SlumberDemon/disnake-Pagination/blob/main/src/Paginator.py
"""
...
class Simple(disnake.ui.View):
    ...
    async def start(self, ctx: commands.Context, pages: list[disnake.Embed]):
        ...
        # The only two lines modified from the GitHub page:
        await ctx.send(embed=self.pages[self.InitialPage], view=self)
